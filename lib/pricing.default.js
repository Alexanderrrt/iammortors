...
export const DEFAULT_PRICING = {
  ...
  services: [
    ...
    },
    {
      id: "used-tires",
      icon: "usedTire",
      label: { en: "Used Tires", es: "Llantas Usadas" },
      model: "perUnit",
      appliesVehicleFactor: true,
      basePrice: 50, // per tire, sedan baseline
      unitLabel: { en: "tires", es: "llantas" },
      qty: { min: 1, max: 4, default: 2 },
      fees: [
        { label: { en: "Mount & balance", es: "Montaje y balanceo" }, amount: 20, per: "unit" },
        { label: { en: "Disposal", es: "Desecho" }, amount: 4, per: "unit" },
      ],
    },
    {
