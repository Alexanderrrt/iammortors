...
// Real shop photography only — displayed in a uniform, colour-graded grid.
export const GALLERY_IMAGES = [
  { src: "/media/gallery/collision-repair.png", alt: { en: "Technicians performing collision repair on a vehicle", es: "Técnicos reparando una colisión en un vehículo" } },
  { src: "/media/gallery/diagnostics.png", alt: { en: "Technician running computer diagnostics under the hood", es: "Técnico realizando diagnóstico por computadora bajo el capó" } },
  { src: "/media/gallery/paint-body.png", alt: { en: "Technician painting a vehicle in the spray booth", es: "Técnico pintando un vehículo en la cabina de pintura" } },
  { src: "/media/gallery/brakes-suspension.png", alt: { en: "Technician servicing brakes and suspension", es: "Técnico reparando frenos y suspensión" } },
  { src: "/media/gallery/gallery-workshop.png", alt: { en: "IAM Motors workshop at golden hour", es: "Taller de IAM Motors al atardecer" } },
  { src: "/media/gallery/frame-alignment.png", alt: { en: "Frame straightening on the alignment rack", es: "Enderezado de chasis en el banco de alineación" } },
  { src: "/media/gallery/maintenance.png", alt: { en: "Technician performing routine maintenance", es: "Técnico realizando mantenimiento de rutina" } },
