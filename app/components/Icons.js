...
const GLYPHS = {
  ...
  shield: (
    <>
      <path d="M12 3.2 19 6v5.3c0 4.2-2.7 7.5-7 9.5-4.3-2-7-5.3-7-9.5V6l7-2.8z" />
      <path d="m8.6 12.1 2.2 2.2 4.7-4.8" />
    </>
  ),
  clipboard: (
    <>
      <rect x="5" y="4.5" width="14" height="16" rx="1.5" />
      <path d="M9 4.5V3h6v1.5M8.5 10h7M8.5 14h5M8.5 17h3" />
    </>
  ),
  car: (
    <>
      <path d="m5 16-1-4 2-5h12l2 5-1 4" />
      <path d="M4 12h16M6 16v2M18 16v2M7 9h10" />
  ...
  handshake: (
    <>
      <path d="m4 10 3-3 4 2 2-2 3 1 4 3-3 3-3-2-2 2-3-2-2 2-3-3z" />
      <path d="m8 13 2 2 2-1 2 1 2-2" />
    </>
  ),
  estimate: (
    <>
  ...
  language: (
    <>
      ...
      <path d="M3.5 12h17M12 3c2.2 2.4 3.2 5.4 3.2 9S14.2 18.6 12 21M12 3c-2.2 2.4-3.2 5.4-3.2 9S9.8 18.6 12 21" />
    </>
  ),
  walkIn: (
    <>
      <path d="M13 4.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />
      <path d="m11 6-2 5 3 2 1 5M9 11l-3 3M12 13l4-1 2 3M13 18l-2 4" />
    </>
  ),
  oil: (
    <>
